...
import fundamentals.level03.OptionExercises2._
import org.scalactic.TypeCheckedTripleEquals
import org.scalatest.FunSpec

class OptionExercises2Test extends FunSpec with TypeCheckedTripleEquals {
  ...
  describe("findJobByHumanId") {
    ...
    it("should return jobId if humanId is found and Human has a job that is in jobsDatabase") {
      assert(findJobByHumanId(2) === Some(Job("Teacher", "Expert in their field"))) // Timmy
    }
